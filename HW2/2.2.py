...
def save_tensor_as_images(tensor, folder_path):
    ...
    # Only save images if the folder is empty
...
save_tensor_as_images(train_gray, "pathmnist/train")
save_tensor_as_images(test_gray, "pathmnist/test")

train_gray_source = dt.sources.ImageFolder(root="pathmnist/train")
test_gray_source = dt.sources.ImageFolder(root="pathmnist/test")
...
gray_paths = [f"pathmnist/train/{i}.png" for i in range(10)]  # Assumes filenames are image_0.png, image_1.png, etc.
